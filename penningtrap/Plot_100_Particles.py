...
plt.title("Particles left after 500 $\mu s$ for different frequencies with f=0.1 Mhz.")
plt.grid()
...
plt.title("Particles left after 500 $\mu s$ for different frequencies with f=0.4 Mhz.")
plt.grid()
...
plt.title("Particles left after 500 $\mu s$ for different frequencies with f=0.7 Mhz.")
plt.grid()
...
plt.title("Particles left in penning trap for frequencies around $\omega_V = 0.7$.")
plt.grid()
